...
#define PIN_ESP32_SOUND_P04_CLK GPIO_NUM_13
#define PIN_ESP32_SOUND_P05_DI GPIO_NUM_26
#define PIN_ESP32_SOUND_RESET GPIO_NUM_4

// pins used for I2C connection to the PWM multiplexing board
#define PIN_ESP32_PWM_SCL GPIO_NUM_27
#define PIN_ESP32_PWM_SDA GPIO_NUM_14

// pin used to connect to the RC receiver port
#define PIN_ESP32_RC_RX GPIO_NUM_25

// bottom RGB LED controlling pins
#define PIN_ESP32_RGB_LEFT GPIO_NUM_32
#define PIN_ESP32_RGB_RIGHT GPIO_NUM_33

// ulstrasonic distance sensor pins
#define PIN_ESP32_US_TRIG GPIO_NUM_22
#define PIN_ESP32_US_ECHO GPIO_NUM_35

// Infrared obstacle detectors pins
#define PIN_ESP32_IR_FL GPIO_NUM_18
#define PIN_ESP32_IR_FR GPIO_NUM_5
#define PIN_ESP32_IR_DL GPIO_NUM_19
#define PIN_ESP32_IR_DR GPIO_NUM_17
...
#define PIN_PWM_MOTOR_IN1 2
#define PIN_PWM_MOTOR_IN2 1
#define PIN_PWM_MOTOR_IN3 6
#define PIN_PWM_MOTOR_IN4 5
